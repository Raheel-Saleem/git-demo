...
import { Avatar, Box, ButtonBase, Card, CardContent, Grid, InputAdornment, OutlinedInput, Popper, Typography } from '@material-ui/core';
    ...
    return (
        <React.Fragment>
            ...
            <Box sx={{ display: { xs: 'none', md: 'block' } }}>
                ...
                >
                    <Typography variant="h3" color="primary" fontSize="large">
                        Real Estate Web
                    </Typography>
                </Card>
            </Box>
