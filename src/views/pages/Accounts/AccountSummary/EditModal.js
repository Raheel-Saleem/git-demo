                        ...
                        {(formik) => (
                            <Form className="signup-form">
                                <div className="form-group mb-2">
                                    ...
                                    <Field type="text" className="form-control" name="accName" />
                                </div>
                                <div className="form-group mb-2">
                                    <label htmlFor="email">Amount to Invest</label>
                                    <Field type="text" className="form-control" placeholder="johndoe@gmail.com" name="amountToInvest" />
                                </div>
                                <div className="form-group mb-2">
                                ...
                                <div className="form-group mb-2">
                                    <label htmlFor="password">Bank Name</label>
