...
export default function Cheque(props) {
    const {
        formField: { tokenAmount, tokenDays, taxAmount, tokenDescription, taxDescription }
    } = props;
        ...
        <React.Fragment>
            ...
            <Grid container spacing={3}>
                <Grid item xs={12} sm={6}>
                    <InputField name={tokenAmount.name} label={tokenAmount.label} fullWidth variant="outlined" size="small" type="number" />
                </Grid>
                <Grid item xs={12} sm={6}>
